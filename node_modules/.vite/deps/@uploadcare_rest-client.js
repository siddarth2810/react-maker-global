...
// node_modules/@uploadcare/rest-client/dist/esm/index.browser.mjs
var AddonExecutionStatus;
(function(AddonExecutionStatus2) {
  AddonExecutionStatus2["IN_PROGRESS"] = "in_progress";
  AddonExecutionStatus2["ERROR"] = "error";
  AddonExecutionStatus2["DONE"] = "done";
  AddonExecutionStatus2["UNKNOWN"] = "unknown";
})(AddonExecutionStatus || (AddonExecutionStatus = {}));
var AddonName;
(function(AddonName2) {
  AddonName2["UC_CLAMAV_VIRUS_SCAN"] = "uc_clamav_virus_scan";
  AddonName2["AWS_REKOGNITION_DETECT_LABELS"] = "aws_rekognition_detect_labels";
  AddonName2["AWS_REKOGNITION_DETECT_MODERATION_LABELS"] = "aws_rekognition_detect_moderation_labels";
  AddonName2["REMOVE_BG"] = "remove_bg";
})(AddonName || (AddonName = {}));
var BatchResponseStatus;
(function(BatchResponseStatus2) {
  BatchResponseStatus2["OK"] = "ok";
})(BatchResponseStatus || (BatchResponseStatus = {}));
var ConversionStatus;
(function(ConversionStatus2) {
  ConversionStatus2["PENDING"] = "pending";
  ConversionStatus2["PROCESSING"] = "processing";
  ConversionStatus2["FINISHED"] = "finished";
  ConversionStatus2["FAILED"] = "failed";
  ConversionStatus2["CANCELLED"] = "cancelled";
})(ConversionStatus || (ConversionStatus = {}));
var WebhookEvent;
(function(WebhookEvent2) {
  WebhookEvent2["FILE_UPLOADED"] = "file.uploaded";
...
var ConversionType;
(function(ConversionType2) {
  ConversionType2["VIDEO"] = "video";
  ConversionType2["DOCUMENT"] = "document";
})(ConversionType || (ConversionType = {}));
var DEFAULT_MESSAGE = "Unknown error";
var RestClientError = class _RestClientError extends UploadcareError {
  constructor(message, options = {}) {
    ...
    this.status = (_a = options.response) == null ? void 0 : _a.status;
    this.statusText = (_b = options.response) == null ? void 0 : _b.statusText;
    ...
    Object.setPrototypeOf(this, _RestClientError.prototype);
  }
};
...
var Paginator = class {
  constructor(paginatable, options, settings) {
    __publicField(this, "_paginatable");
    __publicField(this, "_options");
    __publicField(this, "_settings");
    __publicField(this, "_page", null);
...
var applyDefaultSettings = (userSettings) => {
  const settings = {
    ...defaultSettings,
    ...userSettings
  };
...
var version = "6.14.1";
var LIBRARY_NAME = "UploadcareRestClient";
...
function retryIfFailed(fn, options) {
  return retrier(({ attempt, retry }) => fn().then(async (response) => {
...
var DEFAULT_API_VERSION = "0.7";
var getAcceptHeader = () => {
  return `application/vnd.uploadcare-v${DEFAULT_API_VERSION}+json`;
};
var CAMELIZE_IGNORE_KEYS = ["metadata", "problems", "appdata"];
var NO_CONTENT_STATUS = 204;
var isJsonContentType = (type) => type && ["application/json", getAcceptHeader()].includes(type);
async function handleApiRequest(options) {
  ...
  if (!isJsonContentType(response.headers.get("content-type"))) {
    throw new RestClientError(void 0, {
      response,
      request
    });
  }
...
(function(PollStrategyJobStatus2) {
  PollStrategyJobStatus2[PollStrategyJobStatus2["FINISHED"] = 0] = "FINISHED";
  PollStrategyJobStatus2[PollStrategyJobStatus2["FAILED"] = 1] = "FAILED";
...
function createJobPoller(options) {
  ...
  return async (options2, runnerSettings) => {
    var _a;
    const { pollOptions, ...runnerOptions } = options2;
    const response = await runner(runnerOptions, runnerSettings);
    const jobs = resolveJobs(response, runnerOptions, runnerSettings);
    if ((_a = pollOptions == null ? void 0 : pollOptions.signal) == null ? void 0 : _a.aborted) {
    ...
    const promises = jobs.map(async (job) => {
      ...
      const pollResult = await poll({
        check: pollStrategy,
        signal: pollOptions == null ? void 0 : pollOptions.signal,
        interval: pollOptions == null ? void 0 : pollOptions.interval,
        timeout: pollOptions == null ? void 0 : pollOptions.timeout
      });
...
var addonJobPoller = async (options, settings) => {
...
async function convert(options, userSettings) {
  ...
  if (isDocument) {
    body["save_in_group"] = (_a = options == null ? void 0 : options.saveInGroup) == null ? void 0 : _a.toString();
  }
  const apiRequest = await makeApiRequest({
    method: "POST",
...
var conversionJobPoller = (options, settings) => {
...
var createSignature = (...args) => {
  return import("./createSignature.browser.b4bcb7f3-SHLDUBV2.js").then((m) => m.createSignature(...args));
};
...
var UploadcareAuthSchema = class {
  constructor(options) {
    __publicField(this, "_publicKey");
    __publicField(this, "_signatureResolver");
    __publicField(this, "_md5Loader");
    ...
    if (md5Loader) {
      ...
      this._md5Loader = import("./md5.browser.c389165d-CDZB3YAR.js").then((m) => m.md5);
    }
  }
  async md5(input) {
...
var UploadcareSimpleAuthSchema = class {
...
//# sourceMappingURL=@uploadcare_rest-client.js.map
